...
import { Check, Sparkles, ArrowRight, LayoutDashboard, XCircle, RefreshCw } from "lucide-react";
...
export default function CheckoutStatusPage() {
  ...
  const selectedPlan = localStorage.getItem("selectedPlan") ? `${localStorage.getItem("selectedPlan")} plan` : " ";
        ...
        <div className="min-h-full flex items-center justify-center p-6 lg:p-8 overflow-y-auto">
          ...
          >
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-[#0f172a]/95 to-[#0f172a]/80 p-8 lg:p-10 text-center shadow-xl shadow-emerald-500/5">
              ...
              >
                Your subscription {selectedPlan} is now active. You have full access to your plan features.
              </motion.p>
  ...
  // Failure / canceled / any other status
  return (
    <GlobalLayout activeSection="pricing">
      <div className="min-h-full flex items-center justify-center p-6 lg:p-8 overflow-y-auto">
        <motion.div
          ...
          transition={{ duration: 0.4 }}
        >
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-[#0f172a]/95 to-[#0f172a]/80 p-8 lg:p-10 text-center shadow-xl shadow-rose-500/5">
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-rose-500/10 via-transparent to-amber-500/10 pointer-events-none" />
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-24 h-24 rounded-full bg-rose-500/20 blur-2xl" />

            <motion.div
              className="relative mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-rose-500 to-amber-600 shadow-lg shadow-rose-500/30"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ type: "spring", stiffness: 200, damping: 15, delay: 0.1 }}
            >
            ...
            <motion.h1
              ...
              style={{
                fontFamily: "Satoshi, sans-serif",
                background: "linear-gradient(135deg, #ffffff 0%, #fda4af 50%, #fbbf24 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
              }}
            ...
            >
              <Button
                className="bg-gradient-to-r from-rose-500 to-amber-600 text-white shadow-lg shadow-rose-500/25"
                onClick={() => setLocation("/app/pricing")}
              >
